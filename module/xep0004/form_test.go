...
func TestModule_XEP0004_DataForm_FromElement(t *testing.T) {
	...
	form, _ = NewFormFromElement(elem)
	require.NotNil(t, form)
	require.Len(t, form.Reported, 1)
	require.Len(t, form.Items, 1)
	require.Len(t, form.Fields, 1)
}

func TestModule_XEP0004_DataForm_Element(t *testing.T) {
	form := &DataForm{}
	form.Type = Form
	elem := form.Element()
	...
	require.Len(t, elem.Elements().Children("item"), 1)
}
